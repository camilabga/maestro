...
class Vision{
    ...
    public:
        ...
        inline void show(){flip(TheInputImageCopy, TheInputImageCopy, 1);/*imshow("", TheInputImageCopy);*/}
        inline Mat getInputImage(){flip(TheInputImageCopy, TheInputImageCopy, 1);return TheInputImageCopy;}

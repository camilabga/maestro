...
void saveData(float x, float y, int i){
	save << cont << " " << x <<  " " << FRAME_HEIGHT-y << "\n";
}
...
int main(int argc, char* argv[]){
	...
	VideoCapture capture("Videos/IMG_3263.mp4");
    if ( !capture.isOpened() ){
	...
	save.close();
	imwrite( "IMG_3263.png", trajetoria);
